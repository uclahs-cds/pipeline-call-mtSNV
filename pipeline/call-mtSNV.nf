...
def mtoolbox = "blcdsdockerregistry/mtoolbox:1.0.1"
def mitocaller = "blcdsdockerregistry/mitocaller:1.0"
...
process mtoolbox {
  container mtoolbox // TODO: rename the tag to 1.0.0
  containerOptions "-v ${params.mtoolbox_out}:${params.rsrs_out} -v ${params.output_dir}:${params.extract_reads_out}"
