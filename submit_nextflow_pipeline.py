...
def generate_install_requirements_command():
    ...
    nextflow_url = 'https://github.com/nextflow-io/nextflow/releases/download/v20.10.0/nextflow-20.10.0-all'
...
def validate_input_combinations(
    ...
    # if single node use
        ...
        # if submitting to Slurm
            ...
            single_node_invalid_slurm_input_options = {'smp_slots': smp_slots, 'sge_scheduler': sge_scheduler}
